...
struct MenuBarContent: View {
    ...
    private func exportRules() {
        ...
        panel.nameFieldStringValue = "ProfilePrism-Rules.profileprism"
        panel.allowedContentTypes = [.profilePrism]
...
extension UTType {
    static let profilePrism = UTType(exportedAs: "com.badaverse.profileprism.rules")
}
