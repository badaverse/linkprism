...
struct LinkPrismApp: App {
    ...
    var body: some Scene {
        ...
        Window(String(localized: "LinkPrism Help"), id: "help") {
            HelpView()
        }
        ...
        Window(String(localized: "Get Started with LinkPrism"), id: "onboarding") {
        ...
        MenuBarExtra("LinkPrism", image: "MenuBarIcon") {
            MenuBarContent()
                .environmentObject(ConfigManager.shared)
        }
    }
